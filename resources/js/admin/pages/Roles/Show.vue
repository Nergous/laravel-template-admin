            ...
            <NCard padding="var(--kpi-pad)" class="entity-page__card">
                <div class="entity-page__profile">
                    <div>
                        ...
                        <p>{{ role.description || "Описание не задано" }}</p>
                    </div>
                </div>
            </NCard>
            ...
            <NCard padding="var(--kpi-pad)" class="entity-page__card">
                ...
                >
                    <section
                        ...
                        :key="group"
                    >
                        <h3>{{ permissionGroupLabels[group] ?? group }}</h3>
                        <div class="entity-page__badges">
                            <NBadge v-for="name in names" :key="name" pill>{{
                                name
                            }}</NBadge>
                        </div>
                    </section>
                </div>
                <p v-else class="entity-page__muted">Разрешений пока нет.</p>
            </NCard>
                ...
                <dl class="entity-page__details">
                    ...
                    <div>
                        ...
                        <dd>
                            ...
                            >
                            <template v-else>{{ role.users_count }}</template>
                        </dd>
                    </div>
                    <div>
                        <dt>Создана</dt>
