...
return [
    ...
    'after_or_equal' => 'В поле :attribute должна быть дата, равная или позже :date.',
    ...
    'before_or_equal' => 'В поле :attribute должна быть дата, равная или раньше :date.',
    'between' => [
    ...
    'password' => [
        'mixed' => 'Пароль должен содержать как строчные, так и заглавные буквы.',
    ...
    'size' => [
        'numeric' => 'Размер поля :attribute должен быть :size.',
    ...
    'url' => 'Формат поля :attribute неправильный.',
    ...
    |--------------------------------------------------------------------------
    |
    | Russian names substituted for :attribute in the messages above.
    |
    */
